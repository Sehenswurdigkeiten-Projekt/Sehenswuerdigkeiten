...
Future<List> getParsedResponseForQuery(String value) async {
  ...
  var response = json.decode(json.encode(await getSearchResultsFromQueryUsingMapbox(query)));
...
Future<Map> getParsedReverseGeocoding(LatLng latLng) async {
  Map<String, dynamic> response =
      new Map<String, dynamic>.from(json.decode(json.encode(await getReverseGeocodingGivenLatLngUsingMapbox(latLng))));
